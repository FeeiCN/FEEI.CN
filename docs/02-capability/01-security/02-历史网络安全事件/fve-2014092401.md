...
上面截图是其中一个二级域名的管理后台，可以看到很多敏感信息 所有客户网站后台均可以登陆 从`testweb的maindb.t_admin`随便挑选一个用户
...
宁波**信息工程有限公司([http://www.china***.com/](http://www.china%2A%2A%2A.com/)) 登陆地址:[http://www.china***.com/admin/](http://www.china%2A%2A%2A.com/admin/)帐号:lixiang 密码3lxanc**
