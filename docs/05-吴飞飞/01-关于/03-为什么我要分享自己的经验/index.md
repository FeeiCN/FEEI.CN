...
title: 为什么我要分享自己的经验？
icon: send-icon
description: 从白帽子、开源工具、会议分享到企业安全建设经验，记录我为什么持续把安全实践沉淀为公开内容。
---
...
![Cobra 与 GSIL 开源项目相关截图](/media/why-share/image-3-1024x479.webp "图 1：早期开源工具是我把安全能力对外分享的起点。")
...
后来，这件事逐渐从"准备写一本书"变成了更长期的内容系统。安全建设经验被持续沉淀到站内文章、[演讲](/speech)、[出版物](/publications)和安全体系方法论里，不再只是一次会议分享或一篇技术文章。

我更希望这些内容能被复用：安全负责人可以拿去对照自己的体系，工程师可以理解一个漏洞背后的治理链路，后来者可以少走一些我曾经走过的弯路。分享的目标也从"把经验讲出来"，变成"把经验整理成别人能继续使用的方法"。
