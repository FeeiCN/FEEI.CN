...
- `docs/01-网络空间安全/02-人工智能安全/02-智能工程/03-AI转型/` 的入口页应为 `docs/01-网络空间安全/02-人工智能安全/02-智能工程/03-AI转型/03-AI转型.md`。
...
`sidebars.ts` 主要使用基于目录结构的自动侧边栏，因此**移动文档会直接影响导航**。事业有成使用显式侧边栏组合直接挂载的事业文档与子目录；网络空间安全和人生操作系统在一级目录中分别组织专业内容与四个人生目标。
