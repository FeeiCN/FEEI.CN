...
3. 判断观点应归属到哪个内容区域：
   - 健康幸福 → `docs/02-人生系统/01-健康幸福/`
   - 事业有成、能力、职业 → `docs/02-人生系统/02-事业有成/`
   - AI、安全、软件工程 → `docs/01-网络安全/`
   - 财务自由 → `docs/02-人生系统/03-财务自由/`
   - 人生丰富、体验、探索世界 → `docs/02-人生系统/04-人生丰富/`
   - 全局人生框架 → `docs/02-人生系统/00-万事可成/`
