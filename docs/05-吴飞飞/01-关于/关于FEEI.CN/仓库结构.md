...
- `docs/`：站点主体内容，按编号分组为 `01-网络安全/`、`02-人生系统/`、`03-智能工程/` 和 `05-吴飞飞/`；人生系统下包含健康幸福、事业有成、财务自由、人生丰富四个目标，其中带 `SKILL` 徽标的文档是给 AI 协作助手使用的工作规则文件，统一放在 `关于FEEI.CN/` 子目录中。
- `docs/01-网络安全/02-人工智能安全/`：按 AI 系统安全、AI 赋能安全、AI 滥用防御三条主线组织安全内容；通用 AI 原理、使用实践、组织转型和项目独立放在 `docs/03-智能工程/`，通过链接交叉引用。
- `blog/`：博客文章。
