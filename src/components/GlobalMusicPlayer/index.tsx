...
function GlobalMusicPlayerClient() {
  ...
  const [navbarPortalTarget, setNavbarPortalTarget] = useState<HTMLElement | null>(null);
  ...
  useEffect(() => {
    const frameId = window.requestAnimationFrame(() => {
      setNavbarPortalTarget(document.querySelector<HTMLElement>('.navbar__items--right'));
    });
  ...
  return (
    <>
      {groupSwitcher && navbarPortalTarget ? createPortal(groupSwitcher, navbarPortalTarget) : null}
      {isPlayerVisible ? (
        <div
          className={clsx(
