...
const favoriteTracks: Audio[] = [
  ...
  localTrack('거짓말', 'BIGBANG', '거짓말-BIGBANG.flac'),
  localTrack('마지막인사', 'BIGBANG', '마지막인사-BIGBANG.flac'),
  localTrack('하루하루', 'BIGBANG', '하루하루-BIGBANG.flac'),
  localTrack('붉은노을', 'BIGBANG', '붉은노을-BIGBANG.flac'),
  localTrack('바보', 'BIGBANG', '바보-BIGBANG.flac'),
  localTrack('BADBOY', 'BIGBANG', 'BADBOY-BIGBANG.flac'),
  localTrack('BAEBAE', 'BIGBANG', 'BAEBAE-BIGBANG.flac'),
  localTrack('BANGBANGBANG', 'BIGBANG', 'BANGBANGBANG-BIGBANG.flac'),
  localTrack('BLUE', 'BIGBANG', 'BLUE-BIGBANG.flac'),
  localTrack('FANTASTICBABY', 'BIGBANG', 'FANTASTICBABY-BIGBANG.flac'),
  localTrack('FXXKIT', 'BIGBANG', 'FXXKIT-BIGBANG.flac'),
  localTrack('HaruHaru', 'BIGBANG', 'HaruHaru-BIGBANG.flac'),
  localTrack('IFYOU', 'BIGBANG', 'IFYOU-BIGBANG.flac'),
  localTrack("Let's not fall in love", 'BIGBANG', "Let'snotfallinlove-BIGBANG.flac"),
  localTrack('LOSER', 'BIGBANG', 'LOSER-BIGBANG.flac'),
  localTrack('Oh Ma Baby', 'BIGBANG', 'OhMaBaby-BIGBANG.flac'),
  localTrack('SOBER', 'BIGBANG', 'SOBER-BIGBANG.flac'),
  localTrack('Tonight', 'BIGBANG', 'Tonight-BIGBANG.flac'),
  localTrack('WE LIKE 2 PARTY', 'BIGBANG', 'WELIKE2PARTY-BIGBANG.flac'),
];
