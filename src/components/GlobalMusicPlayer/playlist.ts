...
const favoriteTracks: Audio[] = [
  ...
  localTrack('Lies', 'BIGBANG', 'LIES-BIGBANG.flac'),
  localTrack('Last Farewell', 'BIGBANG', 'LASTFAREWELL-BIGBANG.flac'),
  localTrack('Red Sunset', 'BIGBANG', 'REDSUNSET-BIGBANG.flac'),
  localTrack('Baebo', 'BIGBANG', 'FOOL-BIGBANG.flac'),
