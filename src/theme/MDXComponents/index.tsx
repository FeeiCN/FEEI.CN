import React, {useEffect, useRef, useState, type ComponentPropsWithoutRef, type ReactNode} from 'react';
import MDXComponents from '@theme-original/MDXComponents';

type TableProps = ComponentPropsWithoutRef<'table'>;

function ResponsiveTable({children, className, ...props}: TableProps): ReactNode {
